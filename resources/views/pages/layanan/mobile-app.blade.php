...
@section('content')
    <!-- ***** Welcome Area Start ***** -->
    <x-hero title="Mobile Application"
        description="Kami menyediakan jasa pembuatan aplikasi mobile yang menerapkan tampilan user friendly, mobile friendly dan modern sesuai dengan kebutuhan Anda."
        background="images/mobile.jpg" />
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-5 col-md-12 col-sm-12 align-self-center" data-aos="fade-right" data-aos-offset="0"
                    ...
                    <img src="/images/mobileE.svg" class="rounded img-fluid d-block mx-auto" alt="App">
                </div>
                ...
                <div class="col-lg-6 col-md-12 col-sm-12 align-self-center mobile-top-fix">
                    <div class="left-heading">
                        ...
                        <h2 class="section-title">Jasa Pembuatan Aplikasi Mobile</h2>
                    </div>
                    <div class="left-text">
                        <p>Kami menyediakan jasa pembuatan aplikasi berbasis web dan software custom sesuai kebutuhan bisnis
                            ...
                            aplikasi yang telah ada saat ini, untuk meningkatkan performa dan kualitas produkKami
                            menyediakan jasa pembuatan aplikasi mobile. Produk kami telah bertransformasi menerapkan
                            tampilan user friendly, mobile friendly dan modern sesuai dengan kebutuhan produk aplikasi Anda.
                            Kami berfokus pada sisi fungsionalitas dari segi User Interface (UI) dan User Experience (UX)
                            aplikasi tersebut.</p>

                        <p>Kami mampu menciptakan aplikasi mobile yang terintegrasi yang tentunya sangat memudahkan Anda
                            dalam meningkatkan produktivitas dan efektivitas dalam mengelola bisnis Anda.</p>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6 col-md-12 col-sm-12 align-self-center mobile-top-fix">
                    ...
                    <div class="left-text">
                        Kami menyediakan jasa pembuatan dan pengembangan aplikasi mobile yang dapat di custom dan fleksibel
                        sehingga kami pastikan benar-benar sesuai dengan kebutuhan Anda.
                    </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6 col-md-12 col-sm-12 align-self-center mobile-top-fix">
                    ...
                    <div class="left-text">
                        <p class="text-muted mb-0 mx-auto para-desc">Kami mengembangkan aplikasi mobile dengan melibatkan
                            tenaga professional dari mobile developer. Kami berfokus pada sisi fungsionalitas dari segi User
                            Interface (UI) dan User Experience (UX) aplikasi yang kami kembangkan.</p>
                    </div>
