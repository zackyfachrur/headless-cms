        ...
        <div class="row  p-5 justify-content-center align-items-center ">
            <div class="container mb-5">
                <div class="col-lg-12 col-md-12 col-sm-12 flex-column d-flex justify-content-center align-items-center"
                    ...
                    <p class="col-lg-6 text-center text-muted mb-0 mx-auto para-desc">Untuk menciptakan kenyamanan dan keuntungan bagi pengguna,
                        ada beberapa benefit yang didapatkan ketika menggunakan layanan kami.</p>
                </div>
            </div>
            <div class="row d-flex justify-content-center" style="gap: 20px; width: 100%;" >

                {{-- Card --}}
                <div class="col-lg-2 col-sm-12 card d-flex flex-column justify-content-start align-items-center"
